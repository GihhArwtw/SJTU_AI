...
print(1 - np.abs(np.array(preds)-np.array(labels)).mean())
...
labels = np.array(label) * 200

fig = plt.figure(figsize=(8,5))
ax1 = fig.add_subplot(111)
ax1.plot(energy[775:975],label='Short-time Energy',color="#637ca1")
plt.legend(loc='upper center')
ax2 = ax1.twinx()
ax2.plot(zcrs[775:975],label='ZCR',color="#ff9999")
ax2.plot(labels[775:975],label='Voice Activity',color="black")
plt.legend(loc='lower center')

fig.savefig("voice_example.pdf")