...
class Node2Vec:
    ...
    def train(self, embed_size=128, epochs=15, neg_spl=10, load_model=None):
    ...
    def train_classifier(self, epochs=10, neg_spl=10, load_pairs=None, load_classifier=None):
        ...
        self._train_pairs = []
        num_training_samples = int(len(pairs) * 0.8)
        batch = []
        labels = []
    ...
    def predict(self, source, target):
        ...
        print(self._classifier(torch.tensor( enc1 - enc2 )))
